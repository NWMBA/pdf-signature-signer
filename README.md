...
- Uses one shared signature-image pipeline for both preview and PDF save, so orientation metadata cannot make the saved PDF differ from what the app showed before saving
